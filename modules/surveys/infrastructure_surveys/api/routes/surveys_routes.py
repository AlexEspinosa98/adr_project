...
from fastapi import APIRouter, Depends, HTTPException, status as response_status, File, UploadFile, Form
...
async def create_survey1(
    ...
    try:
        ...
        result = survey_service.create_survey1(input_dto, api_key, image_paths)
...
async def create_survey2(
    ...
    try:
        ...
        result = survey_service.create_survey2(input_dto, api_key, image_paths)
    except Exception as e:
...
async def create_survey3(
    ...
    try:
        ...
        result = survey_service.create_survey3(input_dto, api_key, image_paths)
    except Exception as e:
