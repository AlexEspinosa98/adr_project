...
class UserProducter(common_entities.BaseEntity):
    ...
    is_producer_organization_member: Optional[bool] = Field(None, description="Is member of a producer organization")
    organization_name: Optional[str] = Field(None, description="Name of the organization")
    representantive1_name: Optional[str] = Field(None, description="Name of the representative")
