...
class Survey1(BaseModel):
    ...
    extensionist_id: Optional[int] = Field(None, description="ID of the extensionist performing the survey")
    user_producter_id: Optional[int] = Field(None, description="ID of the surveyed user/producter")
    ...
    # Campos tipo JSON
    classification_user: Optional[Dict] = Field(None, description="User classification data (JSONB field)")
    medition_focalization: Optional[Dict] = Field(None, description="Measurement and focalization data (JSONB field)")

    # Información general del acompañamiento
    objetive_accompaniment: Optional[str] = Field(None, description="Objective of the accompaniment")
    ...
    observations_visited: Optional[str] = Field(None, description="Observations during visit")

    # Fotografías asociadas
    photo_user: Optional[str] = Field(None, description="Path to user photo")
    photo_interaction: Optional[str] = Field(None, description="Path to interaction photo")
    ...
    state: SurveyStatus = Field(default=SurveyStatus.PENDING, description="Current status of the survey")

    # Cierre y documentación
    date_hour_end: Optional[datetime] = Field(None, description="End date and time of the accompaniment")
    copy_documentation_delivered: Optional[str] = Field(None, description="Indicates if documentation was delivered")

    # Fecha, hora y tipo de acompañamiento
    date_acompanamiento: Optional[str] = Field(None, description="Date of the accompaniment (string format)")
    hour_acompanamiento: Optional[str] = Field(None, description="Hour of the accompaniment")
    origen_register: Optional[str] = Field(None, description="Origin of the record")
    name_acompanamiento: Optional[str] = Field(None, description="Name of the accompaniment type or event")
