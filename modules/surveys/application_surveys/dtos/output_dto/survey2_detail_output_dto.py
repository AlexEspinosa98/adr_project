...
class Survey2DetailOutputDTO(BaseModel):
    ...
    local_practice_tool_technology_coinnovation_identified: Optional[bool] = Field(None, alias="local_practice_tool_technology_coinnovation_identified")
    local_coinovation_or_technology_record: Optional[bool] = Field(None, alias="local_coinovation_or_technology_record")
    ...
    problem_solution_innovation: Optional[str] = Field(None, alias="problem_solution_innovation")
    origin_and_developers: Optional[str] = Field(None, alias="origin_and_developers")
    materials_and_resources: Optional[str] = Field(None, alias="materials_and_resources")
    ...
    observations_extensionist: Optional[str] = Field(None, alias="observations_extensionist")
