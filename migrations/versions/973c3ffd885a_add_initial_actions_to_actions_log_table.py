        ...
        [
            {
                ...
                "description": "Acción de responder una encuesta.",
            },
            {
                "id": 2,
                "action": "Aprobar/Rechazar Encuesta",
                "description": "Acción de aceptar o rechazar una encuesta por parte del administrador.",
            },
        ],
        multiinsert=False,
    )
