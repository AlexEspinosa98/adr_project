...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_user_extensionist_api_token"),
        "user_extensionist",
        ["api_token"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "area_total_linea_productive_primary", sa.String(length=50), nullable=True
        ),
        sa.Column("linea_productive_secondary", sa.String(length=255), nullable=True),
        sa.Column(
            "area_total_linea_productive_secondary", sa.String(length=50), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "previous_visit_recommendations_fulfilled", sa.Boolean(), nullable=True
        ),
        sa.Column("recommendations_commitments", sa.String(length=500), nullable=True),
        ...
        sa.Column(
            "local_coinovation_or_technology_record", sa.Boolean(), nullable=True
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_user_extensionist_api_token"), table_name="user_extensionist"
    )
